...
class TTSManager(Base):
    ...
    def speak(self, text: str, media_player:str = 'media_player.sonos') -> None:
    ...
    def speak_greeting(self, person:str, message:str, media_player:str = 'media_player.sonos')->None:
    ...
    def set_volume_level(self, volume_level:str, media_player:str = 'media_player.sonos')->None:
